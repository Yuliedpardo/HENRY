...
where Sucursal NOT IN (select Sucursal from sucursal); -- Corregir
...
UPDATE empleado SET Sucursal = 'Cordoba Quiroz' WHERE Sucursal = 'C';
...
UPDATE empleado SET IdEmpleado = (IdSucursal * 1000000) + IdEmpleado;
